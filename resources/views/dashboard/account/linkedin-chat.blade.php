    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card">
                <div class="card-body">
                    <div class="container-fluid">
                        <profile-linkedin-chat :user="{{json_encode($user)}}" :threads="{{json_encode($conversations)}}"></profile-linkedin-chat>
                    </div>
                </div>
            </div>
        </div>
...
@push('js')
    <script src="/components/profile/linkedin-chat.js"></script>
